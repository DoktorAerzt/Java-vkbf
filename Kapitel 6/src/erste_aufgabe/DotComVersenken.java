...
public class DotComVersenken {
	...
	private void spielEinrichten() {
		//erste ein paar Dot-Coms herstellen und ihnen Namen geben
		...
		System.out.println("Haustie.com, BioWare.com, FragMich.com");
		System.out.println("Verscuhen Sie, sie mit so wenig Versuchen wie möglich zu erledigen.");
	...
	private void beendeSpiel() {
		...
		if (anzahlVersuche <= 18) {
			System.out.println("Sie habe nur " + anzahlVersuche + " Versuche benötigt. Sie erhalten den KinoWelt-Preis!");
		} else {
