...
public class sechste_aufgabe_phraseomat {
	public static void main (String[] args) {
		
		//drei Wortgruppen erstellen, aus denen ausgeählt wird
		String[] wortListeEins = { "verlässliche" , "erfolgsorientierte" , "webbasiert", "allumfassende", "clevere",
								"kundenorientierte", "pfadkritische", "dynamische", "konkurrenzfähige", "verteilte", 
								"zielgerichtete"};
		...
		String[] wortListeDrei = {"Schicht", "Endstufe", "Lösung", "Architektur", "Kernkompetenz", "Strategie", "Kooperation",
